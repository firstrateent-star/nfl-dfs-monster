...
def compile_madden_skill_traits(ratings: pl.DataFrame) -> pl.DataFrame:
    ...
    route = pl.mean_horizontal(
        _numeric(frame, "route_run_short_rating", "short_route_running_rating"),
        _numeric(frame, "route_run_med_rating", "medium_route_running_rating"),
        _numeric(frame, "route_run_deep_rating", "deep_route_running_rating"),
    )
    accuracy = pl.mean_horizontal(
        _numeric(frame, "throw_acc_short_rating", "throw_accuracy_short_rating"),
        _numeric(frame, "throw_acc_mid_rating", "throw_accuracy_mid_rating"),
        _numeric(frame, "throw_acc_deep_rating", "throw_accuracy_deep_rating"),
    )
    return frame.with_columns(
        ...
        _numeric(frame, "accel_rating", "acceleration_rating").alias("madden_acceleration"),
        route.alias("madden_route_running"),
        _numeric(frame, "catch_rating", "catching_rating").alias("madden_catching"),
        _numeric(frame, "cit_rating", "catch_in_traffic_rating").alias("madden_catch_in_traffic"),
        _numeric(frame, "spec_catch_rating", "spectacular_catch_rating").alias("madden_spectacular_catch"),
        _numeric(frame, "release_rating").alias("madden_release"),
        _numeric(frame, "carry_rating", "carrying_rating").alias("madden_carrying"),
        ...
        _numeric(frame, "throw_on_run_rating").alias("madden_throw_on_run"),
        _numeric(frame, "play_action_rating").alias("madden_play_action"),
        _numeric(frame, "break_sack_rating").alias("madden_break_sack"),
        _numeric(frame, "bcv_rating").alias("madden_ball_carrier_vision"),
        _numeric(frame, "juke_move_rating").alias("madden_juke"),
        _numeric(frame, "spin_move_rating").alias("madden_spin"),
        _numeric(frame, "stiff_arm_rating").alias("madden_stiff_arm"),
        _numeric(frame, "truck_rating").alias("madden_trucking"),
        _numeric(frame, "jump_rating").alias("madden_jump"),
        _numeric(frame, "injury_rating").alias("madden_injury"),
        _numeric(frame, "stamina_rating").alias("madden_stamina"),
    ).select(
        ...
        "madden_spectacular_catch", "madden_release", "madden_carrying", "madden_break_tackle",
        "madden_strength", "madden_agility", "madden_change_of_direction", "madden_awareness",
        "madden_throw_power", "madden_throw_accuracy", "madden_throw_under_pressure",
        "madden_throw_on_run", "madden_play_action", "madden_break_sack",
        "madden_ball_carrier_vision", "madden_juke", "madden_spin", "madden_stiff_arm",
        "madden_trucking", "madden_jump", "madden_injury", "madden_stamina",
