...
def _record_v638_manifest(out: Path) -> None:
    ...
    manifest.update(
        {
            ...
            "v638_conditional_carries_from_2022_2025_empirical_distribution": True,
            "v638_qb_rush_mass_frozen_to_v636": True,
            ...
            "v638_live_run_matchup_authority": float(
            ...
            "runtime_authority_map_v638": {
                ...
                "wr_te_rush_entry": "existing rush_role_probability used only as entry probability",
...
def main() -> None:
    ...
    try:
        v61.configure_reality_loop_v2 = compose_v638_runtime
        v61.main()
    finally:
    ...
    _record_v638_manifest(out)
    write_runtime_fingerprint_v638(out)
