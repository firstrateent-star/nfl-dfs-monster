...
def main() -> None:
    ...
    # Madden is scouting-style proxy evidence, never market information. Failure remains neutral,
    # but successful ingestion now covers both OL blocking and QB/RB/WR/TE mechanism traits.
    try:
