...
def freeze_inputs(inputs: dict[str, pl.DataFrame]) -> dict[str, pl.DataFrame]:
    ...
    # though live roster/depth/injury information is refreshed through Monday.
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Build live 2026 Week 2 personnel using Monday pre-lock "
    ...
    manifest["benchmark_input_freeze"] = {
        "name": "week2_2026_mnf_pregame_2026-09-21",
