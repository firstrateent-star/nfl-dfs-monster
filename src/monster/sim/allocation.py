...
def _allocate_team(
    ...
    # Use the same pressure world generated by the game engine. OL/front/coverage state
    # therefore changes sacks and target availability in the same Sunday reality that
    # generated the team score instead of being resampled independently downstream.
    ...
    # Disrupted pass worlds reduce per-completion efficiency slightly; positive/negative
    # OL run states flow directly into rushing efficiency. Both remain tightly bounded.
