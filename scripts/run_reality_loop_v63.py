...
def configure_reality_loop_v63() -> None:
    """Activate validated v6.3 role/snap authority, return geometry and persistent game tails."""
    ...
    manifest.update(
        {
            ...
            "v631_multiband_return_experiment_promoted": False,
            "v631_rejection_reason": (
                "Paired 300-game shadow barely changed non-offensive TDs and materially narrowed "
                "the score distribution; retained only as diagnostic evidence."
            ),
            "v63_principle": (
