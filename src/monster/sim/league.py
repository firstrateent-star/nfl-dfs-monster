...
def simulate_league_context_game(
    *,
    ...
    Historical team policy builds the starting TeamState. Current roster/depth/snap and
    capability evidence supplies every unit player automatically. Optional team/player
    mechanism inputs (e.g. Madden, weather, continuity, health) are layered afterward.
    Market data is never accepted by this API.
    """
