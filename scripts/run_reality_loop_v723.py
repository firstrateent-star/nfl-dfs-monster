...
def _record_v723_manifest(out) -> None:
    ...
    manifest.update(
        {
            ...
            "v723_base_architecture": "v7.2.2-week2-reality-failure-paths",
            "v723_left_tail_mass_calibrated": True,
            "v723_explicit_drive_finishing_stalls": True,
            "v723_qb_benching_tightened": True,
            "v723_scoreboard_remains_event_derived": True,
